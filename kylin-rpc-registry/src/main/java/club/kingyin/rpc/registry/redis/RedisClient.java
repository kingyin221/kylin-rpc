...
package club.kingyin.rpc.registry.redis;

import com.alibaba.nacos.api.exception.NacosException;
import club.kingyin.rpc.common.annotation.Service;
import club.kingyin.rpc.common.constant.Cons;
import club.kingyin.rpc.common.util.ClazzUtils;
import club.kingyin.rpc.common.util.SpringUtils;
import club.kingyin.rpc.registry.api.RegistryClient;
import club.kingyin.rpc.registry.util.RedisClientFactory;
...
public class RedisClient implements RegistryClient {
    ...
    club.kingyin.rpc.registry.api.RedisClient redisClient = RedisClientFactory.newRedisClient(HOST);
    ...
    private void regiInstanceIfNecessary(club.kingyin.rpc.registry.api.RedisClient redisClient, String ip, int port, Map<String, Object> idServiceMap, Class cls) throws InstantiationException, IllegalAccessException {
